...
extern int    file_readSint64  (file * fp, int64_t * buffer) ;
extern int    file_readUint64  (file * fp, uint64_t * buffer) ;
...
extern int    file_readSint64A (file * fp, int64_t * buffer, int n) ;
extern int    file_readUint64A (file * fp, uint64_t * buffer, int n) ;
...
extern int    file_writeSint64 (file * fp, int64_t * buffer) ;
extern int    file_writeUint64 (file * fp, uint64_t * buffer) ;
...
extern int    file_writeSint64A(file * fp, int64_t * buffer, int n) ;
extern int    file_writeUint64A(file * fp, uint64_t * buffer, int n) ;
