...
extern int64_t instance_getid() ;
extern INSTANCE * instance_get( int64_t id ) ;
extern INSTANCE * instance_get_by_type( uint64_t type, INSTANCE ** context ) ;
...
extern void instance_dump( INSTANCE * father, int64_t indent ) ;
