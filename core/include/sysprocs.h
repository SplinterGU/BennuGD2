...
SYSPROC sysprocs[MAX_SYSPROCS] = {
    /* Internal use */
    { 0x01, "#COPY#"        , "PV++Q" , TYPE_POINTER    , 5, SYSMACRO(bgd_copy_struct)                  },
    { 0x02, "#MEMCOPY#"     , "PPQ"   , TYPE_INT64      , 3, SYSMACRO(bgd_internal_memcopy)             },
    { 0x03, "#COPYSTRA#"    , "PPQ"   , TYPE_INT64      , 3, SYSMACRO(bgd_internal_copy_string_array)   },
