...
/* Tabla de conversiÛn de caracteres MS-DOS a Windows */
...
/* Tabla de conversiÛn de caracteres Windows a MS-DOS */
...
void init_c_type ()
{
    ...
    set_c_upper  ((const unsigned char *)"√°√©ÌÛ˙ÒÁ‡ËÏÚ˘‰ÎÔˆ√º˝‚ÍÓÙ˚Ê„Âı",
                  (const unsigned char *)"¡…Õ”⁄—«¿»Ã“ŸƒÀœ÷‹›¬ Œ‘€∆√≈’") ;
    set_c_lower  ((const unsigned char *)"¡…Õ”⁄—«¿»Ã“ŸƒÀœ÷‹›¬ Œ‘€∆√≈’",
                  (const unsigned char *)"√°√©ÌÛ˙ÒÁ‡ËÏÚ˘‰ÎÔˆ√º˝‚ÍÓÙ˚Ê„Âı") ;
#else
    set_c_upper  ((const unsigned char *)"√°√©ÌÛ˙Ò—Á«‡ËÏÚ˘‰ÎÔˆ√º˝‚ÍÓÙ˚Ê„Âı¡…Õ”⁄",
                  (const unsigned char *)"AEIOUNNCCAEIOUAEIOUYAEIOU∆AAOAEIOU") ;
    set_c_lower  ((const unsigned char *)"√°√©ÌÛ˙Ò—Á«‡ËÏÚ˘‰ÎÔˆ√º˝‚ÍÓÙ˚Ê„Âı¡…Õ”⁄",
                  (const unsigned char *)"aeiounnccaeiouaeiouyaeiou∆aaoaeiou") ;
#endif
    ...
    set_c_range ('a', 'z', CTYPE_ALPHA) ;
    set_c_from  ((const unsigned char *)"√°√©ÌÛ˙¡…Õ”⁄Ò—Á«‡ËÏÚ˘¿»Ã“Ÿ‰ÎÔˆ√ºƒÀœ÷‹ˇ˝‚ÍÓÙ˚¬ Œ‘€"
                 "Ê∆„Âı™∫√≈–’ÿ", CTYPE_ALPHA) ;
