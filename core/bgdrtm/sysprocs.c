...
int64_t handler_hook_allocated = 0;
int64_t handler_hook_count = 0;

INSTANCE_HOOK * instance_create_hook_list = NULL;
int64_t instance_create_hook_allocated = 0;
int64_t instance_create_hook_count = 0;

INSTANCE_HOOK * instance_destroy_hook_list = NULL;
int64_t instance_destroy_hook_allocated = 0;
int64_t instance_destroy_hook_count = 0;

INSTANCE_HOOK * instance_pre_execute_hook_list = NULL;
int64_t instance_pre_execute_hook_allocated = 0;
int64_t instance_pre_execute_hook_count = 0;

INSTANCE_HOOK * instance_pos_execute_hook_list = NULL;
int64_t instance_pos_execute_hook_allocated = 0;
int64_t instance_pos_execute_hook_count = 0;

INSTANCE_HOOK * process_exec_hook_list = NULL;
int64_t process_exec_hook_allocated = 0;
int64_t process_exec_hook_count = 0;

FN_HOOK * module_initialize_list = NULL;
int64_t module_initialize_allocated = 0;
int64_t module_initialize_count = 0;

FN_HOOK * module_finalize_list = NULL;
int64_t module_finalize_allocated = 0;
int64_t module_finalize_count = 0;
...
static void get_token() {
    ...
    if ( ISNUM( *token_ptr ) ) {
        ...
        token.type = NUMBER;
        token.code = num;
        snprintf( token.name, sizeof( token.name ), "%" PRId64, token.code );
        return;
    }
...
int64_t sysproc_add( char * name, char * paramtypes, int64_t type, void * func ) {
...
SYSPROC * sysproc_get( int64_t code ) {
