...
{                                   \
  ...
  high_reg = (unsigned) ( intptr_t ) POP_FAILURE_ITEM ();                \
  DEBUG_PRINT2 ("  Popping high active reg: %d\n", high_reg);       \
                                    \
  low_reg = (unsigned) ( intptr_t ) POP_FAILURE_ITEM ();             \
...
int
re_search_2 (
     struct re_pattern_buffer *bufp, const char *string1, int size1, const char *string2,
     int size2,
     int startpos,
     int range,
     struct re_registers *regs,
                      ...
                      for (r = *p; r < *p + *(p + 1); r++)
                        {
                          ...
                          /* xx why this test?  */
                          if ((int) ( intptr_t ) old_regend[r] >= (int) ( intptr_t ) regstart[r])
