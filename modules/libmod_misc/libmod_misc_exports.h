...
DLSYSFUNCS  __bgdexport( libmod_misc, functions_exports)[] =
{
    ...
    FUNC( "PROJECT"                 , "DDDDDDPPPP"  , TYPE_DOUBLE       , libmod_misc_math_parallel_through_point   ),
...
*/
    ...
    /* List */
    FUNC( "LIST_CREATE"             , ""            , TYPE_POINTER      , libmod_misc_list_create                   ),
    FUNC( "LIST_CREATE"             , "I"           , TYPE_POINTER      , libmod_misc_list_create2                  ),
    FUNC( "LIST_FREE"               , "P"           , TYPE_INT          , libmod_misc_list_free                     ),
    FUNC( "LIST_EMPTY"              , "P"           , TYPE_INT          , libmod_misc_list_empty                    ),
    FUNC( "LIST_INSERTITEM"         , "PP"          , TYPE_INT          , libmod_misc_list_insertItem               ),
    FUNC( "LIST_REMOVEITEM"         , "PP"          , TYPE_INT          , libmod_misc_list_removeItem               ),
    FUNC( "LIST_WALK"               , "PP"          , TYPE_POINTER      , libmod_misc_list_walk                     ),
    FUNC( "LIST_SIZE"               , "P"           , TYPE_INT          , libmod_misc_list_size                     ),
