...
DLSYSFUNCS  __bgdexport( libmod_misc, functions_exports)[] =
{
    ...
    FUNC( "MEM_SET"         , "PBI"     , TYPE_INT          , libmod_misc_mem_memset             ),
    FUNC( "MEM_SETW"        , "PWI"     , TYPE_INT          , libmod_misc_mem_memsetw            ),
    FUNC( "MEM_SETI"        , "PII"     , TYPE_INT          , libmod_misc_mem_memseti            ),
    ...
    FUNC( "MEMSET"          , "PBI"     , TYPE_INT          , libmod_misc_mem_memset             ),
    FUNC( "MEMSETI"         , "PII"     , TYPE_INT          , libmod_misc_mem_memsetq            ),
    FUNC( "MEMSETW"         , "PWI"     , TYPE_INT          , libmod_misc_mem_memsetw            ),
    FUNC( "MEMSETI"         , "PiI"     , TYPE_INT          , libmod_misc_mem_memseti            ),
