...
DLSYSFUNCS  __bgdexport( libmod_sound, functions_exports )[] = {
    ...
    FUNC( "MUSIC_GET_VOLUME"            , "I"           , TYPE_INT      , libmod_sound_get_music_volume                     ), // require SDL2_Mixer >= 2.6.0
    ...
    FUNC( "MUSIC_GET_PLAYBACK_POSITION" , "I"           , TYPE_DOUBLE   , libmod_sound_get_music_playback_position          ), // require SDL2_Mixer >= 2.6.0
    FUNC( "MUSIC_GET_TIME_POSITION"     , "I"           , TYPE_DOUBLE   , libmod_sound_get_music_playback_position          ), // require SDL2_Mixer >= 2.6.0
    FUNC( "MUSIC_GET_DURATION"          , "I"           , TYPE_DOUBLE   , libmod_sound_get_music_duration                   ), // require SDL2_Mixer >= 2.6.0
    FUNC( "MUSIC_GET_DURATION"          , ""            , TYPE_DOUBLE   , libmod_sound_get_music_duration_current           ), // require SDL2_Mixer >= 2.6.0
    FUNC( "MUSIC_GET_LOOP_START"        , "I"           , TYPE_DOUBLE   , libmod_sound_get_music_loop_start_time            ), // require SDL2_Mixer >= 2.6.0
    FUNC( "MUSIC_GET_LOOP_START"        , ""            , TYPE_DOUBLE   , libmod_sound_get_music_loop_start_time_current    ), // require SDL2_Mixer >= 2.6.0
    FUNC( "MUSIC_GET_LOOP_END"          , "I"           , TYPE_DOUBLE   , libmod_sound_get_music_loop_end_time              ), // require SDL2_Mixer >= 2.6.0
    FUNC( "MUSIC_GET_LOOP_END"          , ""            , TYPE_DOUBLE   , libmod_sound_get_music_loop_end_time_current      ), // require SDL2_Mixer >= 2.6.0
    FUNC( "MUSIC_GET_LOOP_LEN"          , "I"           , TYPE_DOUBLE   , libmod_sound_get_music_loop_length_time           ), // require SDL2_Mixer >= 2.6.0
    FUNC( "MUSIC_GET_LOOP_LEN"          , ""            , TYPE_DOUBLE   , libmod_sound_get_music_loop_length_time_current   ), // require SDL2_Mixer >= 2.6.0
    ...
    FUNC( "HAS_MUSIC_DECODER"           , "S"           , TYPE_INT      , libmod_sound_has_music_decoder                    ), // require SDL2_Mixer >= 2.6.0
    FUNC( "MUSIC_GET_TYPE"              , "I"           , TYPE_INT      , libmod_sound_get_music_type                       ),
    FUNC( "MUSIC_GET_TITLE"             , "I"           , TYPE_STRING   , libmod_sound_get_music_title                      ), // require SDL2_Mixer >= 2.6.0
    FUNC( "MUSIC_GET_TITLE_TAG"         , "I"           , TYPE_STRING   , libmod_sound_get_music_title_tag                  ), // require SDL2_Mixer >= 2.6.0
    FUNC( "MUSIC_GET_ARTIST_TAG"        , "I"           , TYPE_STRING   , libmod_sound_get_music_artist_tag                 ), // require SDL2_Mixer >= 2.6.0
    FUNC( "MUSIC_GET_ALBUM_TAG"         , "I"           , TYPE_STRING   , libmod_sound_get_music_album_tag                  ), // require SDL2_Mixer >= 2.6.0
    FUNC( "MUSIC_GET_COPYRIGHT_TAG"     , "I"           , TYPE_STRING   , libmod_sound_get_music_copyright_tag              ), // require SDL2_Mixer >= 2.6.0
    FUNC( "MUSIC_GET_TYPE"              , ""            , TYPE_INT      , libmod_sound_get_music_type_current               ),
    FUNC( "MUSIC_GET_TITLE"             , ""            , TYPE_STRING   , libmod_sound_get_music_title_current              ), // require SDL2_Mixer >= 2.6.0
    FUNC( "MUSIC_GET_TITLE_TAG"         , ""            , TYPE_STRING   , libmod_sound_get_music_title_tag_current          ), // require SDL2_Mixer >= 2.6.0
    FUNC( "MUSIC_GET_ARTIST_TAG"        , ""            , TYPE_STRING   , libmod_sound_get_music_artist_tag_current         ), // require SDL2_Mixer >= 2.6.0
    FUNC( "MUSIC_GET_ALBUM_TAG"         , ""            , TYPE_STRING   , libmod_sound_get_music_album_tag_current          ), // require SDL2_Mixer >= 2.6.0
    FUNC( "MUSIC_GET_COPYRIGHT_TAG"     , ""            , TYPE_STRING   , libmod_sound_get_music_copyright_tag_current      ), // require SDL2_Mixer >= 2.6.0
